...
- Automated: If project has E2E test infrastructure (Cypress, Playwright, etc.)
- Script: If verifiable via CLI/API calls
- Manual: If requires visual/UX verification — provide exact reproduction steps
...
Inform: "E2E 테스트가 완료되었습니다. `/si:start`로 돌아가서 최종 검증을 진행하세요."
